...
exports.MEDICAL_PRODUCTS_SEED = void 0;
exports.seedMedicalProducts = seedMedicalProducts;
exports.MEDICAL_PRODUCTS_SEED = [
    {
        id: 1,
 ...
 */
async function seedMedicalProducts(db) {
    for (const product of exports.MEDICAL_PRODUCTS_SEED) {
        const result = await db.query(`INSERT INTO medical_products (name, sku, category, clinical_info, indications, procedure_steps, interpretation, complementary_products, target_profiles, keywords)
        ...
        for (const presentation of product.presentations) {
            await db.query(`INSERT INTO product_presentations (medical_product_id, units, price_mxn, sku)
                 VALUES ($1, $2, $3, $4)
                 ON CONFLICT (sku) DO UPDATE
                   SET price_mxn = EXCLUDED.price_mxn`, [productId, presentation.units, presentation.price_mxn, presentation.sku]);
        }
    }
    console.log(`✓ Seeded ${exports.MEDICAL_PRODUCTS_SEED.length} medical products with presentations`);
}
