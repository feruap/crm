...
exports.CLINICAL_RULES_SEED = void 0;
exports.seedClinicalRules = seedClinicalRules;
exports.CLINICAL_RULES_SEED = [
    {
        ...
        recommendation_reason: 'Para un control prenatal seguro, recomendamos screening de enfermedades infecciosas transmisibles: prueba de embarazo, VIH, sífilis y hepatitis B. El protocolo de COFEPRIS requiere estas pruebas.',
    ...
    },
    {
        ...
        recommendation_reason: 'Con síntomas respiratorios, el panel rápido permite diagnóstico diferencial inmediato de influenza A/B, COVID-19 y RSV. Evita pruebas múltiples y acelera manejo clínico.',
    ...
    },
    {
        ...
        recommendation_reason: 'La HbA1c es el estándar de oro para evaluar control glucémico en los últimos 3 meses. Recomendamos evaluación cada 3 meses en diabéticos.',
        client_profile_filter: ['laboratorio', 'consultorio', 'hospital', 'clinica'],
    ...
    },
    {
        ...
        recommendation_reason: 'Para screening laboral, la prueba en orina es estándar, económica y no invasiva. Los 5 parámetros cubren drogas de abuso más comunes.',
        client_profile_filter: [], // Todos
    ...
    },
    {
        ...
        recommendation_reason: 'En urgencias, la prueba en sangre detecta drogas activas en circulación y permite manejo inmediato. Tiempo de resultado: 5 minutos.',
    ...
    },
    {
        ...
        recommendation_reason: 'El screening de ETS incluye VIH, sífilis y hepatitis B. Protocolo estándar de salud pública para relaciones sexuales sin protección.',
        client_profile_filter: ['laboratorio', 'consultorio', 'hospital', 'clinica'],
    ...
    },
    {
        ...
        recommendation_reason: 'Permite identificar influenza A o B, diferenciando de COVID-19 o RSV. Importante para manejo antivirales tempranos.',
    ...
    },
    {
        ...
        recommendation_reason: 'El RSV es la causa más común de bronquiolitis en lactantes. Diagnóstico rápido permite aislamiento y cuidados preventivos.',
    ...
    },
    {
        ...
        recommendation_reason: 'Evaluación del estatus de vitamina D (25-hidroxivitamina D) es esencial en osteoporosis, raquitismo y sospecha de deficiencia.',
    ...
    },
    {
        ...
        recommendation_reason: 'Diagnóstico rápido en 15 minutos. Alta especificidad (99%) permite aislamiento inmediato si es positivo.',
        client_profile_filter: [],
    ...
    },
    {
        ...
        recommendation_reason: 'El HBsAg permite descartar hepatitis B en fiebre prolongada. Hepatitis B es transmisible y requiere aislamiento.',
 ...
 */
async function seedClinicalRules(db) {
    for (const rule of exports.CLINICAL_RULES_SEED) {
        await db.query(`INSERT INTO clinical_decision_rules
    ...
    console.log(`✓ Seeded ${exports.CLINICAL_RULES_SEED.length} clinical decision rules`);
}
