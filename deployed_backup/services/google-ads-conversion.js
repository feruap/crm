...
exports.sendGooglePurchaseConversion = sendGooglePurchaseConversion;
exports.retryFailedGoogleEvents = retryFailedGoogleEvents;
...
// ─────────────────────────────────────────────
async function uploadOfflineConversion(conversion) {
 ...
 */
async function sendGooglePurchaseConversion(orderId, attributionId) {
    ...
    try {
        ...
        const gclidTouch = await db_1.db.query(`SELECT gclid, event_source_url
...
// Retry Failed Events
// ─────────────────────────────────────────────
async function retryFailedGoogleEvents() {
