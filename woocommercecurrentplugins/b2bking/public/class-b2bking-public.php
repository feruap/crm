...
class B2bking_Public{
	...
	*/
	...
	function b2bking_variations_table_shortcode_content( $atts ){
	    ...
	    if (!empty($product_id)){
	    	echo do_shortcode('[b2bking_bulkorder theme=cream product_list="'.$product_id.'" multiselect="yes" style="'.$style.'" hidecolumns="'.$hidecolumns.'" width="'.$width.'"]');
	    	?>
	    	<style type="text/css">
					...
					<div class="b2bking_bulkorder_form_cream_main_container b2bking_filters_closed">
						<div class="b2bking_bulkorder_form_container_cream_filters b2bking_filters_closed">
							<div class="b2bking_bulkorder_form_container_cream_filters_content_first">
								...
								?>
								<div class="b2bking_bulkorder_filter_header b2bking_bulkorder_filter_header_categories <?php if ($category !== 0){echo 'b2bking_categories_orderform_hidden';} ?>"><?php echo apply_filters('b2bking_creamform_taxonomy_filter_name', esc_html__('Categories','b2bking'));?></div>
    ...
    function b2bking_bulk_variations_table(){
    	...
    	if ($is_enabled === 'yes' && $location === 'below'){
	    	echo do_shortcode('[b2bking_bulkorder theme=cream product_list="'.$product_id.'" multiselect="yes"]');
	    	?>
	    	<style type="text/css">
	    		.b2bking_bulkorder_form_container_content_line_cream_view_options, .b2bking_bulkorder_cream_header_container{
	    			display:none !important;
		...
		if (in_array($list_author_id, $subaccounts_list )){
			...
			if ($purchase_lists_theme !== 'classic'){
				add_filter('b2bking_purchase_list_display', function($list, $purchase_list_id, $products_list_comma, $list_title){
					...
					echo do_shortcode('[b2bking_bulkorder width="nonadaptive" multiselect="no" theme='.$purchase_lists_theme.' product_list="'.$products_list_comma.'"]');
	...
	function enqueue_public_resources(){
	    ...
	    */
    	...
    	$data_to_be_passed = array(
    		...
    		'added_cart_event' => apply_filters('b2bking_trigger_added_cart_event', true) ? 1 : 0,
