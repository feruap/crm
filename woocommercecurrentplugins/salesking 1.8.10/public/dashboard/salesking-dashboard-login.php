...
<html>
    <head>
        ...
        add_action( 'salesking_dashboard_footer', 'wp_print_media_templates' );
        ...
        add_action('wp_print_styles', function(){
            global $wp_styles;
            $wp_styles->queue = array('salesking_dashboard', 'jquerymodalzz', 'b2bkingintegrationsk', 'select2', 'media-views');
        });
        add_action('wp_print_scripts', function(){

            global $wp_scripts;
            $wp_scripts->queue = array('salesking_dashboard_bundle','salesking_dashboard_scripts','salesking_dashboard_chart','salesking_public_script', 'salesking_dashboard_messages', 'salesking_dashboard_chart_sales', 'dataTablesButtons', 'jszip', 'pdfmake', 'dataTablesButtonsHTML', 'dataTablesButtonsPrint', 'dataTablesButtonsColvis', 'vfsfonts', 'jquerymodalzz', 'select2', 'wc-country-select', 'wc-address-i18n', 'media-editor','media-audiovideo');
        });
        ...
        if (intval(get_option('salesking_change_color_scheme_setting', 0)) === 1){
            ...
            <style type="text/css">
                ...
                #salesking_dashboard_customers_table .bg-primary, #salesking_dashboard_offers_table .bg-primary {
                                ...
                                <div class="card">
                                    <div class="card-inner card-inner-lg">
                                        ...
                                        if (isset($_GET['reason'])){
                                            ...
                                            <div class="example-alert">
                                                <div class="alert alert-danger alert-icon alert-dismissible">
                                                    <em class="icon ni ni-cross-circle"></em> <strong><?php esc_html_e('Login failed','salesking');?></strong>! <?php echo esc_html($reason);?> <button class="close" data-dismiss="alert"></button></div>
                                            </div><br />
                                            <?php
                                        }
                                        ?>
                                    ...
                                    do_action('salesking_after_login');
