        ...
        <div class="nk-main ">
            ...
            <div class="nk-wrap ">
                ...
                if ($page === 'announcements'){
                    ...
                    // Include minimal WooCommerce admin files needed for order display
                    if (!defined('SALESKING_WC_DIR_ADMIN')){
                        define('SALESKING_WC_DIR_ADMIN', dirname( WC_PLUGIN_FILE ) . '/includes/admin');
                    }
                    include_once SALESKING_WC_DIR_ADMIN . '/wc-admin-functions.php';
                    include_once SALESKING_WC_DIR_ADMIN . '/wc-meta-box-functions.php';
                    
                    // Initialize order-related classes
                    $classes = array(
                        'WC_Meta_Box_Order_Items' => 'includes/admin/meta-boxes/class-wc-meta-box-order-items.php',
                        'WC_Meta_Box_Order_Notes' => 'includes/admin/meta-boxes/class-wc-meta-box-order-notes.php',
                    ...
                    include(apply_filters('salesking_dashboard_template','manage-order.php'));
                }
                ...
                <div id="salesking_footer_hidden">
                    <?php
                    if (apply_filters('salesking_display_footer_scripts', false) || $page === 'manage-order'){
                        wp_footer();
                    }
                    ?>
                </div>
