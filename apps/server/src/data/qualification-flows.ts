...
export interface ExpectedPatterns {
  keywords: string[];
}
...
export interface QualificationFlows {
  [flowType: string]: QualificationFlow;
}
...
export const QUALIFICATION_FLOWS: QualificationFlows = {
...
export function getFirstQualificationStep(flowType: string): QualificationStep | null {
  const flow = QUALIFICATION_FLOWS[flowType];
 ...
 */
export function calculateQualificationScore(answers: QualificationAnswers): QualificationScore {
 ...
 */
export function shouldRouteToSalesAgent(score: QualificationScore): boolean {
  // Route to sales if:
 ...
 */
export function getRoutingRecommendation(score: QualificationScore): RoutingRecommendation {
