        ...
        <div className="fixed bg-white border border-slate-200 rounded-2xl shadow-2xl z-50 flex flex-col"
            ...
            {view === 'cart' && (
                <div className="flex flex-col flex-1 min-h-0">
                    ...
                    {/* Cart footer */}
                    {cart.length > 0 && (
                        <div className="border-t bg-slate-50 p-4 shrink-0 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                            ...
                            <button onClick={generateCheckoutLink} disabled={creatingOrder}
                                className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-xl transition-colors disabled:opacity-60 disabled:cursor-not-allowed shadow-sm">
                                {creatingOrder ? (
                            ...
                            <p className="text-center text-[10px] text-slate-400 mt-1.5">
                                Se enviará el link al chat del cliente · SalesKing calculará comisión
                            </p>
                        </div>
                    )}
                </div>
